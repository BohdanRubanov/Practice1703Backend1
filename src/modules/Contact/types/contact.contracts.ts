...
export interface ContactControllerContract {
    create: (req: Request<object, Icontact[] | string, InferType<typeof ContactSchema.contact>, object, {
        userId: number;
    }>, res: Response<Icontact | string, {
        userId: number;
    }>, next: NextFunction) => void;
    getAll: (req: Request<object, Icontact[], object, object, {
        userId: number;
    }>, res: Response<Icontact[] | string, {
        userId: number;
    }>, next: NextFunction) => void;

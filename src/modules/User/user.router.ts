...
UserRouter.post("/register", uploadMiddleware.single("avatar"), procImgMiddleware(300, 100), validateMiddleware(UserSchema.register), UserController.register);
UserRouter.get("/me", authMiddleware, UserController.me);
UserRouter.get("/username/:username", authMiddleware, UserController.getUserByUsername);
UserRouter.get("/:username", authMiddleware, UserController.getUserByUsername);
